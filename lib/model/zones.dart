...
class ZoneAPI {
  ...
  static Future<http.Response> getZones(String url) async {
    print("zones.dart.getZones Base Url: $url");
  ...
  static Future<http.Response> changeZone(String baseUrl, String zone, String setting, String adjustment) async {
    var url = "$baseUrl/zones/$zone/$setting/";
    print("zones.dart.changeZone Change zone $url"); 
...
class Zone {
  ...
  String channelAdjust(int adjust) {
    ...
    print("zones.dart.channelAdjust ch " + newChannel.toString().padLeft(2, '0'));
